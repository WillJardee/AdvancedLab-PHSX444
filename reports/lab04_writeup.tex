...
%	\caption{Position data for the 200 Hz capture rate for the Bad Data. Both the X and Y characteristics are show here. Notice the repeating pattern in the Y position frequency domain. That is probably the result of the four large peaks in the time domain; probably from a gust of air.}
...
%	\caption{The velocity data for the 200 Hz capture rate for the Bad Data. The same characteristics that can be seen in the 60 Hz capture rate also seem to be here. Consequently it would seem that they are probably the result of micro-motion.}
